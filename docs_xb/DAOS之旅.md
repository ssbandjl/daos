# DAOS之旅[](https://docs.daos.io/v2.0/QSG/tour/#daos-tour)

## 介绍[¶](https://docs.daos.io/v2.0/QSG/tour/#introduction)

本文档提供了对 daos_admin 的 DAOS 管理命令 (dmg) 和 daos_client 用户的 DAOS 工具 (daos) 的一般介绍。本章提供以下帮助和设置：

- Pool 和 Container 在 DAOS 服务器上为 daos_admin 和 daos_client 用户创建、列出、查询和销毁。
- 新用户使用 dmg 和 daos 工具时的常见错误和解决方法。
- DAOS 文件系统之间的数据传输示例，通过设置 DAOS dfuse 挂载点并使用 dfuse fio 和 mpirun mdtest 运行流量。
- 基本 dmg 和 daos 工具的示例在 2 台主机 DAOS 服务器和 1 台主机客户端上运行，并在 4 台主机 DAOS 服务器上通过 dfuse fio 和 mpirun mdtest 运行 DAOS 重建。

## 要求[¶](https://docs.daos.io/v2.0/QSG/tour/#requirements)

为服务器、客户端和管理节点列表设置环境变量。
...
## 设置[¶](https://docs.daos.io/v2.0/QSG/tour/#set-up)

有关 RPM 安装、daos 服务器/代理/管理配置 yml 文件、证书生成以及启动 DAOS 服务器和客户端的信息，请参阅[DAOS RHEL 设置](https://docs.daos.io/v2.0/QSG/setup_rhel/)或[DAOS SUSE 设置。](https://docs.daos.io/v2.0/QSG/setup_suse/)

## 使用 dfuse fio 运行[¶](https://docs.daos.io/v2.0/QSG/tour/#run-with-dfuse-fio)

### required rpm[¶](https://docs.daos.io/v2.0/QSG/tour/#required-rpm)

```
$ sudo yum install -y fio
```

### 运行fio[¶](https://docs.daos.io/v2.0/QSG/tour/#run-fio)
...
### 卸载[¶](https://docs.daos.io/v2.0/QSG/tour/#unmount)
...
## 使用 mpirun mdtest 运行[¶](https://docs.daos.io/v2.0/QSG/tour/#run-with-mpirun-mdtest)

### 所需转速[¶](https://docs.daos.io/v2.0/QSG/tour/#required-rpms)
...
### 运行 mpirun ior 和 mdtest[¶](https://docs.daos.io/v2.0/QSG/tour/#run-mpirun-ior-and-mdtest)
...
### 运行 mpirun mdtest[¶](https://docs.daos.io/v2.0/QSG/tour/#run-mpirun-mdtest)
...
## 使用 4 个 DAOS 主机服务器运行，使用 dfuse io 和 mpirun 重建[¶](https://docs.daos.io/v2.0/QSG/tour/#run-with-4-daos-hosts-server-rebuild-with-dfuse-io-and-mpirun)

### 环境变量设置[¶](https://docs.daos.io/v2.0/QSG/tour/#environment-variables-setup)
...
### 运行 dfuse[¶](https://docs.daos.io/v2.0/QSG/tour/#run-dfuse)
...
### 使用重建运行 dfuse[¶](https://docs.daos.io/v2.0/QSG/tour/#run-dfuse-with-rebuild)
...
### 运行 mpirun mdtest 并重新构建[¶](https://docs.daos.io/v2.0/QSG/tour/#run-mpirun-mdtest-with-rebuild)
...
## 清理[¶](https://docs.daos.io/v2.0/QSG/tour/#clean-up)
