...
const struct daos_task_api dc_funcs[] = {
	...
	{dc_obj_query_key, sizeof(daos_obj_query_key_t)},	// DAOS_OPC_OBJ_QUERY_KEY 查询键
	{dc_obj_sync, sizeof(struct daos_obj_sync_args)},
	{dc_obj_fetch_task,		sizeof(daos_obj_fetch_t)},     // DAOS_OPC_OBJ_FETCH  查询/读
	{dc_obj_update_task,		sizeof(daos_obj_update_t)},   // DAOS_OPC_OBJ_UPDATE 更新/写
